...
// Estraggo il carattere di controllo
	...
	public char controllaCorrettezzaChar() {
		...
		for (int i = 6; i < 8; i++) {
			...
			if (!(Character.isDigit(strCodFisc.charAt(i))) && ((strCodFisc.charAt(i) != 'L')
					&& (strCodFisc.charAt(i) != 'M') && (strCodFisc.charAt(i) != 'N') && (strCodFisc.charAt(i) != 'P')
					&& (strCodFisc.charAt(i) != 'Q') && (strCodFisc.charAt(i) != 'R') && (strCodFisc.charAt(i) != 'S')
					&& (strCodFisc.charAt(i) != 'T') && (strCodFisc.charAt(i) != 'U') && (strCodFisc.charAt(i) != 'V')))
				return '2';
		}
		...
		for (int i = 12; i < 15; i++) {
			if (!(Character.isDigit(strCodFisc.charAt(i)))) {
				...
				if ((strCodFisc.charAt(i) != 'L') && (strCodFisc.charAt(i) != 'M') && // controllo
						...
						(strCodFisc.charAt(i) != 'Q') && (strCodFisc.charAt(i) != 'R') && (strCodFisc.charAt(i) != 'S')
						&& (strCodFisc.charAt(i) != 'T') && (strCodFisc.charAt(i) != 'U')
...
//se arrivo a questo punto vuol dire che la data è corretta 
	...
	/**
	 * Tabella (di tipo Vector) dei valori dei caratteri con posizione di ordine
	 * dispari.
	 */
	...
	/**
	 * Tabella (di tipo Vector) dei valori dei numeri con posizione di ordine
	 * dispari.
	 */
