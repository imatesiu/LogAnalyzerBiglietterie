 ...
 * partita iva e del codice fiscale delle persone non fisiche confrontando anche
 * il valore del check-digit la classe restituisce un codice di ritorno che può
 * assumere dei valori predeterminati
 */
public class UCheckNum {
	...
	/**
	 * Costruttore parametrico che inizializza l'oggetto con la stringa che gli
	...
	/**
	 * Metodo che gestisce il caso di una partita iva o di un codice fiscale di una
	 * persona non fisica
	 * 
	 * @return char
	...
	/**
	 * Metodo pubblico di codifica del return code che acquisisce una stringa
	 * contenente un solo carattere al quale corrisponde una stringa di dettaglio
	 * sul codice di ritorno
	 * 
	 */
	...
	/**
	 * Metodo che esegue sulla stringa partita iva il controllo sul check-digit
	 * calcolando il complemento a dieci dell'ultimo carattere a destra
	 */
...
//somma dei valori attribuiti alle cifre pari 
		for (int i = 1; i < 11; i += 2) {
			...
			String strS2 = String.valueOf(pintAppo); // passo di nuovo a stringa per dividerla in due parti senza
														// utilizzare un array
...
// controllo del complemento a dieci della cifra a destra del totale 
	...
	/**
	 * Metodo che inizializza una partita iva prendendo come parametro di passaggio
	 * una stringa.
	 */
	...
	/**
	 * Metodo pubblico di controlli formali sulle parti che compongono la partita
	 * iva in maniera specifica sul codice ufficio e sul carattere di controllo;per
	 * quanto riguarda i numeri di codice fiscale a 11 cifre oltre al check digit
	 * viene controllato anche il codice dell'ufficio; se trattasi di numeri di
	 * codice fiscale provvisori assegnati dalle fonti DU.74 DU.75 e 101.75, vengono
	 * controllati anche i range dei progressivi assegnati; quindi accede alla
	 * routine di attribuzione dei return code da restituire
	 */
