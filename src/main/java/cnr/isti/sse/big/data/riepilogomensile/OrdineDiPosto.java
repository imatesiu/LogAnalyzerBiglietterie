 ...
 *         &lt;element ref="{http://siae.it/mensile}TitoliIVAPreassoltaAnnullati" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/mensile}BigliettiAbbonamento" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/mensile}BigliettiAbbonamentoAnnullati" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/mensile}AbbonamentiFissi" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OrdineDiPosto {
    ...
    @XmlElement(name = "AbbonamentiFissi")
    protected List<AbbonamentiFissi> abbonamentiFissi;
    ...
    /**
     * Recupera il valore della proprietà ivaEccedenteOmaqqi.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà ivaEccedenteOmaqqi.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Gets the value of the abbonamentiFissi property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abbonamentiFissi property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbbonamentiFissi().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AbbonamentiFissi }
     * 
     * 
     */
    public List<AbbonamentiFissi> getAbbonamentiFissi() {
        if (abbonamentiFissi == null) {
            abbonamentiFissi = new ArrayList<AbbonamentiFissi>();
        }
        return this.abbonamentiFissi;
    }
