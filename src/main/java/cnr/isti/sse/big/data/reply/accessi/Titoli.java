 ...
 *         &lt;element ref="{http://tempuri.org/accessi}TotaleTipoTitolo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Titoli {
    ...
    @XmlElement(name = "TotaleTipoTitolo", required = true)
    protected List<TotaleTipoTitolo> totaleTipoTitolo;
    ...
    /**
     * Gets the value of the totaleTipoTitolo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the totaleTipoTitolo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTotaleTipoTitolo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TotaleTipoTitolo }
     * 
     * 
     */
    public List<TotaleTipoTitolo> getTotaleTipoTitolo() {
        if (totaleTipoTitolo == null) {
            totaleTipoTitolo = new ArrayList<TotaleTipoTitolo>();
        }
