 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://siae.it/gionaliero}CodiceAbbonamento"/>
 *         &lt;element ref="{http://siae.it/gionaliero}Validita"/>
 *         &lt;element ref="{http://siae.it/gionaliero}TipoTassazione"/>
 *         &lt;element ref="{http://siae.it/gionaliero}Turno"/>
 *         &lt;element ref="{http://siae.it/gionaliero}CodiceOrdine"/>
 *         &lt;element ref="{http://siae.it/gionaliero}TipoTitolo"/>
 *         &lt;element ref="{http://siae.it/gionaliero}QuantitaEventiAbilitati"/>
 *         &lt;element ref="{http://siae.it/gionaliero}AbbonamentiEmessi" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/gionaliero}AbbonamentiAnnullati" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/gionaliero}AbbonamentiIVAPreassolta" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://siae.it/gionaliero}AbbonamentiIVAPreassoltaAnnullati" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
